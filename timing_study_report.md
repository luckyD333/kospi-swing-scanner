...
> **결론을 사용하지 마세요 (2026-09-19 확인)**
> 이 보고서의 "오전 진입 유리" 결론은 룩어헤드로 오염됐습니다. 진입 시점을 고르는 데
> 그날의 종가 정보가 섞여 들어갔기 때문에, 실제로는 낼 수 없는 성과입니다. 수치와 표는
> 기록으로 남겨 두되 매매 판단에 쓰지 마세요.
> Strategy Six·Seven 은 애초에 이 보고서의 대상이 아닙니다
> (`backtest_engine/timing_study.py:10-16` 의 전략 목록에 없습니다).
