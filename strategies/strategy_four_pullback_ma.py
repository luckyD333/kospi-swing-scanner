...
class StrategyFourConfig:
    ma_trend: int = 20          # 추세 확인 SMA (2026-05-19 WF 롤백: 30→20, 운영값 30 0/9 windows best)
    ma_pullback: int = 5        # 눌림목/회복 SMA
    pullback_lookback: int = 5  # 눌림목 감지 기간 (전일까지 N봉) (2026-05-19 WF 롤백: 3→5, OOS decay 0.465)
